...
EXPECTED_MARKETPLACE_VERSION = "1.12.0"
...
def main() -> int:
    ...
    if "no-cringe" not in claude["nuko-nova-unslop"].get("tags", []):
        fail("Nuko Nova Unslop: Claude no-cringe tag is missing")
